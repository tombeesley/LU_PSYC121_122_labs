...
Let's look at that variable for just a subset of data. Use the select, filter and pipe commands to process the data, store the resulting data as tibble, and then plot that data:
