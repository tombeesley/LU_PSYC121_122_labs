...
Variables can also store strings of *characters*, which must be placed in "":

```{r, echo =TRUE}
my_name <- "Bob"
```

Variables can have multiple items in them, whether they be numbers or characters. For example it is often useful to create an *vector*:
