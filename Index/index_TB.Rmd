...
### [Week 7](https://tombeesley.shinyapps.io/Week_7/)

This set of exercises teaches the `summarise()` and `group_by()` verbs, which are used to drill down into data to extract meaningful summaries across levels of categorical variables. Students will need to then answer a set of queries using these commands in R Studio. 
